...
#                                 Mini-Projeto
#
#         Prevendo a inadimplência de clientes com Machine Learning e PowerBI
#
#*******************************************************************************
...
################ Análise Exploratório, Limpeza e Transformação #################
...
dados_clientes <- na.omit(dados_clientes)#omite valores ausentes
...
# Convertendo a variável para o tipo fator etária
...
# Construindo a primeira versão do modelo (target ~(=) variável preditora(. = todas variáveis preditoras))
...
modelo_v2 <- randomForest(inadimplente ~ PAY_0 + BILL_AMT1 + BILL_AMT2 + BILL_AMT3 + BILL_AMT6 + LIMIT_BAL + BILL_AMT5,
                          data = dados_treino)
...
# Carregando o modelo
modelo_final <- readRDS("modelo/modelo_v2.Rds")
